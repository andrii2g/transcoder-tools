...
apply_profile_preset_defaults() {
  ...
  for key in width height video_bitrate audio_bitrate video_codec audio_codec audio_sample_rate quality crf video_filter extra_output_args gop keyint_min sc_threshold video_preset video_tune; do
